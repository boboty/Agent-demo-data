...
6. 切换并打开 06-competitor-listing-optimization。生成脚本复用 AGENTS.md.template、Demo 03 project-context 和 BrewGo 公共资料，并预置 task.md、离线 HTML 报告模板与空 outputs/。竞品由课堂对话中的关键词在线发现，用户确认后才写入 HTML。
