...
- 当前 Listing、评论和既有文案不自动构成产品事实；资料不足或冲突时明确标记待确认。
- 不补造产品、市场或客户信息；推测必须写明依据和缺失证据。
- 结果只写入 outputs/，并为重要修改保留来源文件或事实依据。
- 价格、退款、Listing 发布、客户承诺、广告否定词和采购动作只输出建议，必须人工确认。
- 完成前自检事实引用、关键 SKU、单位、口径、输出文件和人工确认项。
